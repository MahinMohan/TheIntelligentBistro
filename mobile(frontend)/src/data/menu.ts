...
export const menuItems: MenuItem[] = [
  // ── STARTERS ───────────────────────────────────────────────────────────────
  {
    ...
    description:
      'Crispy saffron risotto balls filled with black truffle and aged fontina, served with truffle aioli and micro herb salad.',
    price: 18,
  ...
  },
  {
    ...
    description:
      'House-made burrata on roasted heirloom tomatoes, basil oil, aged balsamic reduction, and fleur de sel.',
    price: 16,
  ...
  },
  {
    ...
    description:
      'Slow-cooked Carnaroli rice with porcini, chanterelle, and king oyster mushrooms, finished with truffle butter and aged Parmesan.',
    price: 28,
  ...
  },
  {
    ...
    description:
      'Moroccan-spiced lamb shoulder braised 8 hours with preserved lemon, olives, apricot, and harissa, over saffron couscous.',
    price: 38,
  ...
  },
  {
    ...
    description:
      'Line-caught sea bass, crispy skin, on celeriac purée, wilted spinach, shellfish bisque, and samphire.',
    price: 36,
  ...
  // ── DESSERTS ───────────────────────────────────────────────────────────────
  {
    ...
    description:
      'Warm 70% Valrhona chocolate fondant with molten centre, Madagascan vanilla bean ice cream, and gold dust.',
    price: 14,
  ...
  },
  {
    ...
    description:
      'Silky Tahitian vanilla custard with a perfectly caramelised sugar crust, fresh seasonal berries and shortbread.',
    price: 13,
  ...
  },
  {
    ...
    name: 'Lemon Tart',
    description:
      'Sicilian lemon curd in a buttery pâte sablée shell, Italian meringue, candied lemon zest, and raspberry coulis.',
    price: 12,
  ...
  },
  {
    ...
    description:
      'Warm Medjool date sponge drenched in butterscotch toffee sauce, clotted cream, and a sprinkle of sea salt.',
    price: 13,
  ...
  // ── DRINKS ─────────────────────────────────────────────────────────────────
  {
    ...
    description:
      "Beluga vodka, fresh-pulled double espresso, Kahlúa, and demerara sugar — topped with a three-bean foam.",
    price: 16,
  ...
  },
  {
    ...
    name: 'Aged Negroni',
    description:
      "Barrel-aged Hendrick's gin, Campari, and Carpano Antica sweet vermouth, over a large clear ice cube with orange peel.",
    price: 18,
